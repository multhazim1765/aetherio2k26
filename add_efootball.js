...
// Insert the new event before the closing bracket of EVENTS_DATA
const insertIndex = content.lastIndexOf('];');
if (insertIndex !== -1) {
  content = content.slice(0, insertIndex) + newEvent + content.slice(insertIndex);
  fs.writeFileSync(path, content, 'utf8');
  console.log('Successfully added E-Football event');
} else {
  console.error('Could not find the end of EVENTS_DATA array');
}
